		...
		<div id="bookDiv">
			<div>
				<h2> <u>Things I'm doing right now</u> </h2>
					...
					<p>Tried to join the gorup but it didn't exist. Getting it restarted.</p>
					...
					Would reccomend if you don't like the fact that you're going to forget most of what you read. Here are some of the results <a href = "https://notes.harrytaussig.com" target="_blank">so far</a>.</p>
					...
					<h3>Drums</h3>
					<p>I used to play bass but drums is definitely where it's at. Also trying to get better so I can play with my friends since we already have a bassist.</p>
